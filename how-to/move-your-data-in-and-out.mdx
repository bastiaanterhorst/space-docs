...
All of this lives in the **Backup & Import** window on Mac (the **Sonto** menu → **Backup & Import**).

## Bring tasks in from another app

<Steps>
  <Step title="Open the Import tab">
    In **Backup & Import**, choose **Import**. Sonto can bring tasks from **Apple Reminders**, **Todoist**,
    and **Things 3**.
  </Step>
...
<Steps>
  ...
  <Step title="Make one on the spot and keep it safe">
    ...
    somewhere off your Mac — an external drive or cloud storage. See [Backup & Import](/reference/manage-data).
  </Step>
</Steps>
