...
Space connects to the calendars already on your Mac and iPhone, shows your events next to your tasks,
...
On the Day or Week screen, Space invites you to add your calendars. Click the arrow to open
...
Settings → Internet Accounts**: any account there with calendars enabled shows up in Space, ready to
add.
...
When you put a task on your calendar, Space marks the event **private** by default. Anyone with access
to your calendar sees only "Busy" rather than the task's name and notes.

- For Google calendars specifically, connect your Google account in Space (**Connect Google account**)
...
For a meeting with a video link, Space shows a video icon. Open the event and click **Join Video Call**,
right-click and choose **Join Video Call**, or hover and press <kbd>Cmd</kbd> + <kbd>J</kbd>. You can
also accept, decline, or mark an invitation tentative right from Space.
...
- **Let Space find time:** select a task and press <kbd>Cmd</kbd> + <kbd>F</kbd> (or right-click →
  **Find time on calendar**). Space finds the first opening that fits, respecting your working hours and
  existing events.

<Frame caption="Time blocking in Space">
<iframe
  className="w-full aspect-video rounded-xl"
...
<CardGroup cols={2}>
  <Card title="Calendar reference" icon="calendar" href="/reference/calendar">
    Every detail of calendars in Space.
  </Card>
