---
title: 'The Basics'
description: 'Your first walkthrough — add tasks, move them around, and find your way around Space'
---

This is the best place to start. By the end you'll know how to add and edit tasks, schedule them, and
move between the screens that make up Space. Watch the walkthrough below, or read the written steps that
follow.

**Prerequisites:** [download Space](https://apps.apple.com/us/app/space-life-planner/id6502294348) and
...
- **Schedule it** using the calendar, or by typing natural language like `November` or `12 November`.
...
In Space, a week is a real planning unit: you can schedule a task **on a week** — meaning you want it
