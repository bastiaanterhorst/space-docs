...
Space uses Apple's native calendaring system, and does not connect to your calendar providers directly. 

The optional exception here is Google. For Google calendars, Space offers the option to create a direct connection between Space and Google to ensure events can be marked private (Apple's system does not expose this option for Google calendars). For more information, see [Google's Privacy Policy](https://policies.google.com/privacy).
