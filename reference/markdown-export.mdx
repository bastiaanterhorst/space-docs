...
Space can turn any view — a day, a week, a project, or a plan — into **Markdown** text. Markdown is
plain text that keeps its structure (headings, lists, checkboxes), so it pastes cleanly into almost
anything.

## Export a view

Open the view you want, then choose **Export as Markdown**. Space produces the Markdown for you to copy
...
task, project, or plan to get a **deeplink** — a link that opens the item straight back in Space. Drop
...
<CardGroup cols={2}>
  <Card title="Connect to AI Agents" icon="robot" href="/reference/ai-with-mcp">
    A live connection between Space and your AI tools.
  </Card>
  <Card title="Manage Data" icon="database" href="/reference/manage-data">
    Back up and move your full Space data.
  </Card>
</CardGroup>
