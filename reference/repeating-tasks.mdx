...
A repeating task comes back automatically, so you only set it up once. Space supports two repeat styles
...
A repeating task can also create a calendar event for each occurrence. You can have Space place the
...
<CardGroup cols={2}>
  <Card title="Auto-schedule" icon="wand-magic-sparkles" href="/reference/auto-schedule">
    Let Space find a free slot on your calendar.
  </Card>
  <Card title="Calendar" icon="calendar" href="/reference/calendar">
    How events and time blocks work in Space.
  </Card>
</CardGroup>
