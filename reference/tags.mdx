...
<Tip>
  While you're naming a task, you can add a tag inline by typing `@` and the tag name — and create a new
  tag on the spot if it doesn't exist yet. See
...
<CardGroup cols={2}>
  ...
  <Card title="Search" icon="magnifying-glass" href="/reference/search">
    Another way to find tasks across Space.
  </Card>
</CardGroup>
