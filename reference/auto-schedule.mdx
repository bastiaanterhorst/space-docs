---
title: Auto-schedule
description: Let Space find an opening on your calendar for a task
---
...
calendar**. Space looks at your calendar, skips over existing events, stays inside your working hours,
...
<CardGroup cols={2}>
  <Card title="Calendar" icon="calendar" href="/reference/calendar">
    Events and time blocks in Space.
  </Card>
