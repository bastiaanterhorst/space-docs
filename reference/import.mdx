...
description: Bring your tasks into Sonto from Apple Reminders, Todoist, and Things
---
...
<Info>
  Importing is part of the **Backup & Import** window on Mac — open the **Sonto** menu, choose
  **Backup & Import…**, then the **Import** tab.
</Info>
...
<Warning>
  Importing is a **Mac** feature, part of the Backup & Import window.
</Warning>
