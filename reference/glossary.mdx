---
title: Glossary
description: The words Space uses, and exactly what each one means
---

Space has a small, precise vocabulary. This page is the canonical reference for what each term means.
...
Space uses "group" in two distinct ways:
...
Typing a task's details — date, time, project or area, and tags — straight into its name, where Space
...
- **Plan** (verb) — the core action in Space. You *plan* your year, quarter, week, and day.
...
Adding something to Space from anywhere, without opening the app — via a global hotkey on Mac, or Siri
...
moment to reflect is a core part of the Space method.
...
The atomic unit of work in Space. A task can be flagged important, scheduled to a day or week, placed
