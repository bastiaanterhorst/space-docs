...
<Frame caption="First activate Space">
  <img src="/images/spotlight/spotlight-1.png" alt="Typing 'add to space' in Spotlight to start capturing a task" />
</Frame>
...
<Frame caption="Then add your task">
  <img src="/images/spotlight/spotlight-2.png" alt="Typing a task name in Spotlight to add it to Space" />
</Frame>
